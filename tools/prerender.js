...
/* ============================================================================
   ...
   WHY THIS EXISTS
   The tour list is rendered client-side by js/main4.js from content/tour.json.
   ...
   WHAT IT DOES
     1. Writes the upcoming shows into tour.html and index.html as real static
        markup, byte-identical to what js/main4.js builds at runtime.
...
/* ---------- helpers shared with js/main4.js (keep these in step) ---------- */
